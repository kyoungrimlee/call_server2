...
if (strpos($_SESSION['viewLog'],$pageKey) ===false) {
	regLog($admin_info['user_id'], '8','view','', '' ,'ENG',$reg_date,'etc_trunk') ;
	if (!$_SESSION['viewLog']){
...
$aFind =array("TNUMBER" => $titEtc['listTitle']['tNo'], "TNAME"=>$titEtc['listTitle']['tName'], "RCODE"=>$titEtc['listTitle']['rGroup']) ; 
...
<div id="container" class="w_custom">
	...
	<div class="sub_head1 clear ">
		<h2 class="sub_head_title fl"><?=$tit['mainTitle']['etc_trunk']?></h2>
	</div>

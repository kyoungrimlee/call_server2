...
if (strpos($_SESSION['viewLog'],$pageKey) ===false) {
	regLog($admin_info['user_id'], '4','view','', '' ,'ENG',$reg_date,'digit') ;
	if (!$_SESSION['viewLog']){
...
$aFind =array("SOURCE" => $titDigit['listTitle']['source'], "TARGET"=>$titDigit['listTitle']['target']) ; 
...
<div id="container" class="w_custom">
	...
	<div class="sub_head1 clear ">
		<h2 class="sub_head_title fl"><?=$tit['mainTitle']['digit']?></h2>
	</div>

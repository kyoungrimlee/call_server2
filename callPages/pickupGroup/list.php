...
if (strpos($_SESSION['viewLog'],$pageKey) ===false) {
	regLog($admin_info['user_id'], '8','view','', '' ,'ENG',$reg_date,'etc_cpgroup') ;
	if (!$_SESSION['viewLog']){
...
$aFind =array("PCODE" => $titEtc['listTitle']['gCode'], "PNAME"=>$titEtc['listTitle']['gName']) ; 
...
<div id="container" class="w_custom">
	...
	<div class="sub_head1 clear ">
		<h2 class="sub_head_title fl"><?=$tit['mainTitle']['etc_cpgroup']?></h2>
	</div>

...
include_once dirname(__FILE__) . "/../../lib/setConfig.php";
 ...
 ##로그기록
$pageKey="etc_groupRring";
if (strpos($_SESSION['viewLog'],$pageKey) ===false) {
	regLog($admin_info['user_id'], '8','view','', '' ,'ENG',$reg_date,'etc_groupRring') ;
	if (!$_SESSION['viewLog']){
...
$aFind =array("RCODE" => $titEtc['listTitle']['rGroup'],"RNAME" => $titEtc['listTitle']['rName'], "PNUMBERS"=>$titEtc['listTitle']['phone']) ; 
$html_page=selectbox("page_num",$aPageNum,$page_num,"","findSelect('')","70");
$html_Find=selectbox("find",$aFind,$find,$msg['allchk'],"","130");
$html_rtype=selectbox("frtype",$arrRtype,$frtype,$titEtc['listTitle']['rType'] ,"findSelect('frtype')","100");
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
			  ...
			  $("#BtnSearch").click(function(e){
				 var params = [ 'find','word','frtype','page_num'];
 		    	 var delparams = [ 'page' ];
...
<div id="container" class="w_custom">
	...
	<div class="sub_head1 clear ">
		<h2 class="sub_head_title fl"><?=$tit['mainTitle']['etc_groupRring']?></h2>
	</div>

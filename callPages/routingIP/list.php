...
if (strpos($_SESSION['viewLog'],$pageKey) ===false) {
	regLog($admin_info['user_id'], '3','view',$tit['mainTitle']['admin'], '' ,'ENG',$reg_date,'rout_ip') ;
	if (!$_SESSION['viewLog']){
...
$aFind =array("IPADDR"=>$titRouting['listTitle']['ip'], "PREFIX" => $titRouting['listTitle']['digit'],  "ROUTING_IP"=>$titRouting['listTitle']['rout_ip']) ; 
...
<div id="container" class="w_custom">
	...
	<div class="sub_head1 clear ">
		<h2 class="sub_head_title fl"><?=$tit['mainTitle']['rout_ip']?></h2>
	</div>

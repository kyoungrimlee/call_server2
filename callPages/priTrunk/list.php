...
if (strpos($_SESSION['viewLog'],$pageKey) ===false) {
	regLog($admin_info['user_id'], '6','view','', '' ,'ENG',$reg_date,'pri') ;
	if (!$_SESSION['viewLog']){
...
$aFind =array("IPADDR" => $titPritg['listTitle']['ipaddr'], "USER_NAME"=>$titPritg['listTitle']['name'], "START_STN"=>$titPritg['listTitle']['extNo'] ,"START_TRK"=>$titPritg['listTitle']['trkNo'] , "CID_NO"=>$titPritg['listTitle']['cidNum'] , "BILL_NO"=>$titPritg['listTitle']['billNum'] ) ; 
$html_page=selectbox("page_num",$aPageNum,$page_num,"","findSelect('')","70");
$html_Find=selectbox("find",$aFind,$find,$msg['allchk'],"","120");


$html_cidType=selectbox("fcType",$arrCidType,$fcType,$titPritg['listTitle']['cidType'] ,"findSelect('fcType')","160");
$html_billType=selectbox("fbType",$arrBillType,$fbType,$titPritg['listTitle']['billType'] ,"findSelect('fbType')","170");
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
			  ...
			  $("#BtnReset").click(function(e){
				 ...
				 var params = [ 'find','word','fcType','fbType','page_num'];
...
<div id="container" class="w_custom">
	...
	<div class="sub_head1 clear ">
		<h2 class="sub_head_title fl"><?=$tit['mainTitle']['pri']?></h2>
	</div>

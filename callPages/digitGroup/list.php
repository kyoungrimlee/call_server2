...
if (strpos($_SESSION['viewLog'],$pageKey) ===false) {
	regLog($admin_info['user_id'], '3','view','', '' ,'ENG',$reg_date,'digit_group') ;
	if (!$_SESSION['viewLog']){
...
$levelKey ="conversion";   //등록,수정,삭제 레벨 
$memu3 ="nowOn";
$subMenu2_2 ="on";
...
$aFind =array("PHONE" => $titDigit['listTitle']['phone'], "SOURCE" => $titDigit['listTitle']['source'], "TARGET"=>$titDigit['listTitle']['target']) ; 
...
<div id="container" class="w_custom">
	...
	<div class="sub_head1 clear ">
		<h2 class="sub_head_title fl"><?=$tit['mainTitle']['digit_group']?></h2>
	</div>

...
include_once dirname(__FILE__) . "/../../lib/historyClass.php";


$vars= getVars('pgroup,chk,rndval');
if (!$_SESSION['Vars']){
...
echo "Total: <strong>".number_format($setClass->recode['total'])."</strong> ( ";
...
<script type="text/javascript">
	$(".bbs_table_list tbody tr").css("cursor","default");
	$(".bbs_table_list tbody tr:nth-child(even) td").css("background-color","#eaeaea")
	...
	/*
	$(".bbs_type1 tbody tr").on("click", function(e){

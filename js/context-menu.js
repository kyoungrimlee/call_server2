...
DHTMLGoodies_contextMenu = function()
{
	...
	this.imagePath = '../../intro_images/tree/';
...
DHTMLGoodies_contextMenu.prototype = 
{
	...
	__displayContextMenu : function(e)
	{
		...
		ref.menuObject.style.left = (e.clientX + Math.max(document.body.scrollLeft,document.documentElement.scrollLeft) +10) + 'px';
		ref.menuObject.style.top = (e.clientY + Math.max(document.body.scrollTop,document.documentElement.scrollTop) - 11) + 'px';
	...
	__createMenuItems : function()
	{
		...
		for(var no in this.menuItems){	// Looping through menu items		
			...
			if ( typeof(this.menuItems[no]['itemText']) !='undefined'){
